        ...
        <div className={styles.section}>
            ...
            <div className={styles.web}>
                <div className={styles["row-1"]}>
                    ...
                    <img className={styles["web-image"]} src="web-images/airbnb-logo.png" />
                </div>
                <div className={styles["row-2"]}>
                    <img className={styles["web-image"]} src="web-images/netflix-logo.png" />
                    <img className={styles["web-image"]} src="web-images/paypal-logo.png" />
                    <img className={styles["web-image"]} src="web-images/coinbase-logo.png" />
                    <img className={styles["web-image"]} src="web-images/uber-logo.png" />
                    <img className={styles["web-image"]} src="web-images/spotify-logo.png" />
                </div>
